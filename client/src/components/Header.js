...
require("@fontsource/alex-brush");
const fa_1 = require("react-icons/fa");
const Header = () => {
    const [theme, setTheme] = (0, react_1.useState)(localStorage.getItem("theme") || "light");
        ...
        >
          ...
          ></path> */}
              ...
              <div className="mx-2 flex-1 px-2">
                {" "}
                <react_router_dom_1.Link to="/home" className="font-bold text-3xl md:text-5xl font-alexBrush">
                  MyBlog
                ...
                <ul className="menu menu-horizontal">
                  <li>
                    <a className="text-xl font-medium">
                      {email && (<>
                          <react_router_dom_1.Link to="/create">Create Post</react_router_dom_1.Link>
                        </>)}
                    </a>
                  </li>
                  <li>
                    ...
                    <a className="text-xl font-medium">
                      {email && (<>
                          <a className="cursor-pointer">
                            <react_router_dom_1.Link to="/settings">Settings</react_router_dom_1.Link>
                          </a>
                        </>)}
                    </a>
                  </li>
          ...
          <div className="drawer-side z-20">
            ...
            <ul className="menu min-h-full text-white font-medium text-xl p-4 bg-black">
              ...
              <li className="pb-4">
                {email && (<>
                    <react_router_dom_1.Link to="/create">
                      Create Post <fa_1.FaPlus />
                    </react_router_dom_1.Link>
                  </>)}
              </li>
              ...
              <li className="pb-4">
                {email && (<>
                    <react_router_dom_1.Link to="/settings">
                      Settings <fa_1.FaCog />
                    </react_router_dom_1.Link>
                  </>)}
              </li>
