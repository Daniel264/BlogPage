...
const Login = () => {
    ...
    return (
        <>
            ...
            <Header />
            <div>
              <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 border-2 w-[450px] h-[420px]">
                  <div className="sm:mx-auto sm:w-full sm:max-w-sm">
                      <h2 className="mt-10 text-center text-2xl md:text-3xl font-bold leading-9">
                          Welcome Back!
                      </h2>
                      <p className="Manrope_light">
